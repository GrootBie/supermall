...
export default {
  ...
  watch: {
    ...
    itemWidth:{
     handler(){
       // this.height=this.itemWidth
       this.height=this.heightdata?this.itemWidth+'px':this.height
     },
     // immediate:true,
    }
      ...
      // }
      // this.swiperheigt1=this.swiperheigt?this.itemWidth:this.height
