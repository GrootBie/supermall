<template>
  ...
  <div class="container">
        <h1>Welcome</h1>
        <div class="form">
            <input type="text"  placeholder="您的账号" v-model="loginForm.username">
            <input type="password" placeholder="您的密码" key="pass" v-model="loginForm.password"
...
<!--  -->
<!--  <nav-bar >-->
<!--    <template v-slot:centerbar>{{minetitle}}</template>-->
...
export default {
  ...
  computed:{
    ...
    methods: {
      changeLogin(tokendict){
        this.$store.commit('changeLogin',tokendict)
      },
